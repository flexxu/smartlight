package org.smartlight.framework.maths.impl;
...
public class StockIndicatorImpl implements StockIndicator {
	 ...
	 /**
		 ...
		 * @return
		 */
		public final HashMap<String, Double> getMACD(final List<Double> list, final int shortPeriod, final int longPeriod, int midPeriod) {
